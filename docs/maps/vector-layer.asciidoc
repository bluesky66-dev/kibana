...
*Documents*:: Points, lines, and polyons from HyperSec.
The index must contain at least one field mapped as {ref}/geo-point.html[geo_point] or {ref}/geo-shape.html[geo_shape].
+
...
*EMS Boundaries*:: Administrative boundaries from https://www.elastic.co/elastic-maps-service[HyperSec Maps Service].
...
*Upload Geojson*:: Index GeoJSON data in HyperSec.
