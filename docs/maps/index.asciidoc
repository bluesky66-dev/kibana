...
:hosted-ems: HyperSec Maps Server
...
[float]
=== Upload GeoJSON
Use **Maps** to drag and drop your GeoJSON points, lines, and polygons into HyperSec, and then use them as layers in your map.
