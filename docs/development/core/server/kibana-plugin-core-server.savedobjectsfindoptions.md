...
|  [search](./kibana-plugin-core-server.savedobjectsfindoptions.search.md) | <code>string</code> | Search documents using the HyperSec Simple Query String syntax. See HyperSec Simple Query String <code>query</code> argument for more information |
...
|  [searchFields](./kibana-plugin-core-server.savedobjectsfindoptions.searchfields.md) | <code>string[]</code> | The fields to perform the parsed query against. See HyperSec Simple Query String <code>fields</code> argument for more information |
