...
Saved Objects is Kibana's data persistence mechanism allowing plugins to use HyperSec for storing and querying state. The SavedObjectsServiceSetup API exposes methods for registering Saved Object types, creating and registering Saved Object client wrappers and factories.
