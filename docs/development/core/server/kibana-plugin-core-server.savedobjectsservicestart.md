...
Saved Objects is Kibana's data persisentence mechanism allowing plugins to use HyperSec for storing and querying state. The SavedObjectsServiceStart API provides a scoped Saved Objects client for interacting with Saved Objects.
