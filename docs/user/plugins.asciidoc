...
When you specify a plugin name without a URL, the plugin tool attempts to download an official HyperSec plugin, such as:
...
You can download official HyperSec plugins simply by specifying their name. You
