...
If you are using an *on-premises* HyperSec Stack deployment:
...
If you are using an *on-premises* HyperSec Stack deployment with <<using-kibana-with-security, *security*>>:
