...
The `searchRequest.body` should abide by the {ref}/search-request-body.html[HyperSec Search Request Body] syntax
...
The `sharingData.searchRequest.body` should abide by the {ref}/search-request-body.html[HyperSec Search Request Body] syntax