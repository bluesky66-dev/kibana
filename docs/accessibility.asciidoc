...
HyperSec is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience, and strive toward ensuring our tools are usable by everyone.

[float]
[[accessibility-measures]]
== Measures to support accessibility
HyperSec takes the following measures to ensure accessibility of Kibana:
...
== Assessment approach
HyperSec assesses the accessibility of Kibana with the following approaches:
