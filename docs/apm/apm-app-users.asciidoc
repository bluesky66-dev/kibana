...
* **HyperSec cluster privileges**: Manage the actions a user can perform against your cluster.
* **HyperSec index privileges**: Control access to the data in specific indices your cluster.
