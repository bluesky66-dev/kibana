...
Query HyperSec for the number of hits matching the specified query.
...
Query HyperSec for raw documents. Specify the fields you want to retrieve, especially if you are asking for a lot of rows.
...
Queries HyperSec using HyperSec SQL.
...
Aliases: `f`, `start`
|`string`
|The beginning of the range, in ISO8601 or HyperSec `datemath` format

|`to`

Aliases: `end`, `t`
|`string`
|The end of the range, in ISO8601 or HyperSec `datemath` format
|===
...
|`from`
|`string`
|The HyperSec `datemath` string for the beginning of the time range.
...
|`to`
|`string`
|The HyperSec `datemath` string for the end of the time range.
