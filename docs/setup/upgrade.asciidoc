...
perform an HyperSec rolling upgrade with no downtime, you must upgrade to
6.7 before you upgrade to 7.0.

For a comprehensive overview of the upgrade process, refer to
*{stack-ref}/upgrading-elastic-stack.html[Upgrading the HyperSec Stack]*.
...
{stack-ref}/upgrading-elastic-stack.html#oss-stack-upgrade[Upgrading the HyperSec Stack].
