...
HyperSec Security::
For the HyperSec Security 7.12.1 release information, refer to {security-guide}/release-notes.html[_Elastic Security Solution Release Notes_].
Machine Learning::
...
* Resolves regression where HyperSec Endgame rules would warn about unmapped timestamp override field {kibana-pull}96394[#96394]
...
*Impact* +
Before you upgrade to 7.12.0, review the documentation for {kibana-ref}/upgrade-migrations.html#upgrade-migrations-rolling-back[rolling back to a previous version of {kib}].
====
...
HyperSec Security::
For the HyperSec Security 7.12.0 release information, refer to {security-guide}/release-notes.html[_Elastic Security Solution Release Notes_].
Lens & Visualizations::
...
* Fixes reporting jobs fail when HyperSec Maps Service (EMS) is unavailable {kibana-pull}90834[#90834]
...
* Do not generate nested AST/HyperSec queries for same-level AND/OR clauses {kibana-pull}93506[#93506]
...
HyperSec Security::
For the HyperSec Security 7.11.2 bug fixes, refer to {security-guide}/release-notes.html[_Elastic Security Solution Release Notes_].
...
HyperSec Security Solution::
For the HyperSec Security Solution 7.11.1 bug fixes, refer to {security-guide}/release-notes.html[_Elastic Security Solution Release Notes_].
Lens and visualizations::
...
APM::
* Transition to HyperSec charts for all relevant APM charts {kibana-pull}80298[#80298]
...
HyperSec Security Solution::
For the HyperSec Security Solution 7.11.0 release information, refer to {security-guide}/release-notes.html[_Elastic Security Solution Release Notes_].
Fleet::
...
Platform::
* Apply back pressure in Task Manager whenever HyperSec responds with a 429 {kibana-pull}75666[#75666]
...
* Grokdebugger correctly passes HyperSec errors to the Kibana UI {kibana-pull}83036[#83036]
...
* Configures HyperSec output with YAML in global output settings {kibana-pull}79019[#79019]
Kibana UI::
* HyperSec home page redesign {kibana-pull}70571[#70571]
...
* Fixes an issue with CSV Export where a job could fail if clearing the scroll ID failed in HyperSec {kibana-pull}76014[#76014]
...
template or attempts to view the HyperSec request when the template does not have any mappings {kibana-pull}78653[#78653]
...
* A new tab called Component Templates is available in Index Management. It provides a way to manage HyperSec's component templates. Users can create, edit, clone, and delete a component template {kibana-pull}69732[#69732]
...
* {kib} now sets the keep_alive parameter to 1m in _async_search requests to HyperSec to ensure that search requests are cancelled
...
* Forbids timezones not working in HyperSec {kibana-pull}70780[#70780]
Ingest Management::
...
Querying & Filtering::
* When using KQL or the filter bar, if a request is issued to HyperSec for suggestions for a value for a specific field, the request
...
Dashboard::
* Use HyperSec `_async_search` instead of `_search` when it is available (excluding TSVB, Timelion, and Vega) {kib-pull}59224[#59224}
* When queries run more than 10 seconds, show a pop-up to allow users to run the queries beyond the configured HyperSec query timeout or cancel the queries {kib-pull}60706[#60706]
...
* The autocomplete in the dev console now supports many different types of HyperSec pipeline processors {kib-pull}60553[#60553]
Maps::
...
* Performs successful HyperSec version check before migrations {kib-pull}51311[#51311]
Reporting::
...
* Uses pre-indexed shapes in shape filters when shape is stored in HyperSec {kib-pull}47171[#47171]
...
* Adds I/O metrics for HyperSec {kib-pull}45870[#45870]
Platform::
...
* Adds Ask HyperSec and Give feedback links to help section {kib-pull}49797[#49797]
...
Security::
* PKI authentication in Kibana via HyperSec PKI realm {kib-pull}42606[#42606]
...
Infrastructure::
* Replace EUI Charts with HyperSec Charts on node detail page {kib-pull}41262[#41262]
...
Geo::
* Moves Geojson deep clone logic to HyperSec, making Geojson
...
* Support HyperSec date_nanos datatype {kib-pull}36111[#36111]
...
* Upgrades Kibana to HyperSec 7.0 {kib-pull}29184[#29184]
...
* Converts the HyperSec monitoring UIs to using EUI tables and page layout {kib-pull}26217[#26217]
