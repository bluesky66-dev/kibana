...
[discrete]
=== Instrumenting with HyperSec APM

{kib} ships with the
https://github.com/elastic/apm-agent-nodejs[HyperSec APM Node.js Agent]
...
centrally managed {es} cluster accessible only to HyperSec
employees.
