...
While the review process is always done by HyperSec staff members, these guidelines apply to all pull requests regardless of whether they are authored by community members or HyperSec staff.
