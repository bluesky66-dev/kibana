...
|The ingest_pipelines plugin provides Kibana support for HyperSec's ingest nodes. Please refer to the HyperSec documentation for more details.
...
|Welcome to the Kibana rollup plugin! This plugin provides Kibana support for HyperSec's rollup feature. Please refer to the HyperSec documentation to understand rollup indices and how to create rollup jobs.
