...
export const Template: FunctionComponent<Props> = ({
  ...
  const logo = (
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="20" viewBox="0 0 421 273">
      ...
      <path className="st1" fill="#0C1A40" d="M14.5,246c0.7,4.6,1.8,9.7,2.7,12.6c0.3,1,0.6,1.7,0.8,2c0.6,0,2.1-0.1,5.9-0.1c6.9,0,17.6,0.1,21.7,0.2
	...
	l0,0.2c1,6.6,1.4,11.9-2.4,15.5c-0.9,0.9-2.6,2.3-4.6,4c-7.3,6.2-22.3,19.2-23.8,24.2C25,202.6,15.4,242.3,14.5,246z"/>
      <rect x="83.4" y="111.1" transform="matrix(-1 -4.490109e-11 4.490109e-11 -1 183.7342 241.5663)" className="st2"
            width="17" height="19.4" fill="#007DC2"/>
      <rect x="134" y="133.5" transform="matrix(-1 -4.490109e-11 4.490109e-11 -1 284.9751 286.4274)" className="st2"
            width="17" height="19.4" fill="#007DC2"/>
      <path className="st2" d="M309.3,241.9h15.9v-19.4h-17.5C307.4,229.3,308,236.2,309.3,241.9z" fill="#007DC2"/>
      <rect x="248.2" y="155.5" transform="matrix(-1 -4.500812e-11 4.500812e-11 -1 513.2592 330.4728)" className="st2"
            width="17" height="19.4" fill="#007DC2"/>
      <rect x="231.2" y="155.5" transform="matrix(-1 -4.490109e-11 4.490109e-11 -1 479.3511 330.4728)" className="st2"
            width="17" height="19.4" fill="#007DC2"/>
      <rect x="358.6" y="177.4" transform="matrix(-1 -4.490109e-11 4.490109e-11 -1 734.1252 374.1687)" className="st2"
            width="17" height="19.4" fill="#007DC2"/>
      <rect x="127.5" y="177.4" transform="matrix(-1 -4.490109e-11 4.490109e-11 -1 272.0211 374.1687)" className="st2"
            width="17" height="19.4" fill="#007DC2"/>
      <rect x="243.7" y="111.1" transform="matrix(-1 -4.495438e-11 4.495438e-11 -1 504.4035 241.5663)" className="st2"
            width="17" height="19.4" fill="#007DC2"/>
      <g>
	...
	C312.5,205.9,312.6,204.1,314.6,204.1z"/>
      ...
      <path className="st2" d="M145.6,82.3l0,27h33.9l0-20.1c0,0,0,0,0,0C165.9,85.9,154.7,83.5,145.6,82.3z" fill="#007DC2"/>
      <g>
        <g>
          ...
          <div className="kbnLoaderWrap">
            ...
            <div
              ...
              data-error-message={i18n('core.ui.welcomeErrorMessage', {
                defaultMessage:
                  'HyperSec did not load properly. Check the server output for more information.',
              })}
            >
              {i18n('core.ui.welcomeMessage', { defaultMessage: 'Loading HyperSec' })}
            </div>
        ...
        <div className="kbnWelcomeView" id="kbn_legacy_browser_error" style={{ display: 'none' }}>
          ...
          <div className="kbnWelcomeText">
            {i18n('core.ui.legacyBrowserMessage', {
              defaultMessage:
                'This HyperSec installation has strict security requirements enabled that your current browser does not meet.',
            })}
          </div>
        </div>
