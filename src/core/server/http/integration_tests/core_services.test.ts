...
describe('http service', () => {
  ...
  describe('legacy elasticsearch client', () => {
    ...
    it('rewrites authorization header via authHeaders to make a request to HyperSec', async () => {
    ...
    it('passes request authorization header to HyperSec if registerAuth was not set', async () => {
