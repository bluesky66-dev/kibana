...
describe('ServerStatus', () => {
  it('renders correctly for green state', () => {
    ...
    expect(component.find('EuiTitle').text()).toMatchInlineSnapshot(`"HyperSec Kibana status is Green"`);
  ...
  it('renders correctly for red state', () => {
    ...
    const component = mount(<ServerStatus serverState={status} name="My Computer" />);
    expect(component.find('EuiTitle').text()).toMatchInlineSnapshot(`"HyperSec Kibana status is Red"`);
    expect(component.find('EuiBadge')).toMatchSnapshot();
  });
  ...
  it('displays the correct `name`', () => {
    ...
    component = mount(<ServerStatus serverState={getStatus()} name="HyperSec Kibana" />);
    expect(component.find('EuiText').text()).toMatchInlineSnapshot(`"HyperSec Kibana"`);
  });
});
