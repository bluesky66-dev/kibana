      ...
      <EuiText>
        ...
        <p>
          <FormattedMessage
            ...
            defaultMessage="By default, HyperSec Kibana scripted fields use {painless}, a simple and secure scripting language designed
        ...
        <p>
          <FormattedMessage
            ...
            defaultMessage="HyperSec Kibana currently imposes one special limitation on the painless scripts you write. They cannot contain named
          functions."
          />
        </p>
        <p>
          <FormattedMessage
            ...
            defaultMessage="Coming from an older version of HyperSec Kibana? The {lucene} you know and love are still available. Lucene expressions
