    ...
    return (
      <React.Fragment>
        <FormattedMessage
          ...
          defaultMessage="Want to help us improve the HyperSec Stack? Data usage collection is currently disabled. Enabling data usage collection helps us manage and improve our products and services. See our {privacyStatementLink} for more details."
          values={{
