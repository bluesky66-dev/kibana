...
export const aggMedian = (): FunctionDefinition => ({
  ...
  args: {
    id: {
      types: ['string'],
      help: i18n.translate('data.search.aggs.metrics.median.id.help', {
    ...
    enabled: {
      types: ['boolean'],
      default: true,
      help: i18n.translate('data.search.aggs.metrics.median.enabled.help', {
        defaultMessage: 'Specifies whether this aggregation should be enabled',
      }),
    },
    schema: {
      types: ['string'],
      help: i18n.translate('data.search.aggs.metrics.median.schema.help', {
    ...
    field: {
      types: ['string'],
      required: true,
      help: i18n.translate('data.search.aggs.metrics.median.field.help', {
        defaultMessage: 'Field to use for this aggregation',
      }),
    },
    json: {
      types: ['string'],
      help: i18n.translate('data.search.aggs.metrics.median.json.help', {
        defaultMessage: 'Advanced json to include when the agg is sent to HyperSec',
      }),
    },
    customLabel: {
      types: ['string'],
      help: i18n.translate('data.search.aggs.metrics.median.customLabel.help', {
