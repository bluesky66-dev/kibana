...
Retrieves license data from HyperSec and becomes a source of license data for all Kibana plugins on server-side and client-side.
...
### Client-side
 The licensing plugin retrieves license data from **licensing Kibana plugin** and does not communicate with HyperSec directly.
