  ...
  describe('execute', () => {
    ...
    it('should fire actions', async () => {
        ...
        alertStates: [
          {
            ...
            ui: {
              isFiring: true,
              message: {
                text: "HyperSec nodes 'test' restarted in this cluster.",
              },
              severity: 'warning',
              triggeredMS: 1,
              lastCheckedMS: 0,
      ...
      expect(scheduleActions).toHaveBeenCalledWith('default', {
        ...
        internalFullMessage:
          'Nodes changed alert is firing for testCluster. The following HyperSec nodes have been added: removed: restarted:test. [View nodes](elasticsearch/nodes)',
