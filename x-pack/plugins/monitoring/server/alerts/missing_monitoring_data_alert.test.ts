        ...
        alertStates: [
          {
            ...
            ui: {
              ...
              message: {
                text:
                  'For the past an hour, we have not detected any monitoring data from the HyperSec node: esName1, starting at #absolute',
                nextSteps: [
                  {
                    text: '#start_linkView all HyperSec nodes#end_link',
                    tokens: [
                      {
