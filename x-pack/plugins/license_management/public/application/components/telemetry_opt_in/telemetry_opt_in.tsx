          ...
          <EuiTitle size="s">
            <h4>
              <FormattedMessage
                ...
                defaultMessage="Help HyperSec support provide better service"
              />
            </h4>
          </EuiTitle>
          <EuiSpacer size="s" />
        ...
        <EuiText className="licManagement__narrowText">
          <p>
            <FormattedMessage
              ...
              This information will not be shared outside of HyperSec.
          ...
          label={
            <span>
              <FormattedMessage
                ...
                defaultMessage="Send basic feature usage statistics to HyperSec periodically. {popover}"
                values={{
                  popover,
                }}
              />
