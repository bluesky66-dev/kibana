      ...
      >
        <p>
          <FormattedMessage
            ...
            defaultMessage="HyperSec Kibana and HyperSec assets that were created by this integration will be removed. Agents policies and any data sent by your agents will not be effected."
          />
        </p>
      </EuiCallOut>
      <EuiSpacer size="l" />
