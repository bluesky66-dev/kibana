    ...
    >
      ...
      <p>
        <FormattedMessage
          ...
          defaultMessage="HyperSec Kibana assets will be installed in the current Space (Default) and will only be accessible to users who have permission to view this Space. HyperSec assets are installed globally and will be accessible to all HyperSec Kibana users."
        />
      </p>
    </EuiConfirmModal>
  );
