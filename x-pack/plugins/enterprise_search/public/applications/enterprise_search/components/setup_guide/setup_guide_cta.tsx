      ...
      <EuiFlexItem className="enterpriseSearchSetupCta__text">
        ...
        <EuiText size="s" color="subdued">
          {i18n.translate('xpack.enterpriseSearch.overview.setupCta.description', {
            defaultMessage:
              'Add search to your app or internal organization with HyperSec App Search and Workplace Search. Watch the video to see what you can do when search is made easy.',
          })}
        </EuiText>
      </EuiFlexItem>
