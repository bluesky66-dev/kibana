...
export const rawNewsApiResponse: RawNewsApiResponse = {
  items: [
    ...
    },
    {
      ...
      publish_on: new Date('2019-12-02T00:00:00'),
      expire_on: new Date('2020-12-31T00:00:00'),
    ...
    },
    {
      ...
      publish_on: new Date('2019-11-17T00:00:00'),
      expire_on: new Date('2020-12-31T00:00:00'),
    ...
    },
    {
      ...
      publish_on: new Date('2019-10-24T00:00:00'),
      expire_on: new Date('2020-12-31T00:00:00'),
    ...
    },
    {
      ...
      publish_on: new Date('2019-10-15T00:00:00'),
      expire_on: new Date('2020-03-01T00:00:00'),
    ...
    },
    {
      ...
      publish_on: new Date('2019-02-13T00:00:00'),
      expire_on: new Date('2020-12-31T00:00:00'),
